        ...
        <section>
            ...
            <div className='px-4 pt-10 pb-24 mx-auto max-w-7xl md:px-2'>
                <div className='grid md:grid-cols-3'>
                    ...
                    <div className='flex sm:justify-center mt-3 sm:pr-2'>
                    <img className='border-2 border-cyan-700 rounded-md h-[300px] w-[400px]
                    ' src={it} alt='' />
                    </div>
